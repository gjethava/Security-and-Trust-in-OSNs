...
# loadding socfb-Bowdoin47 dataset 
...
print(nx.info(g2))
print("Number od nodes:",nx.number_of_nodes(g2))
...
# loadding socfb-Brandeis99 dataset 
...
print(nx.info(g3))
print("Number od nodes:",nx.number_of_nodes(g3))
...
print(nx.info(g4))
print("Number od nodes:",nx.number_of_nodes(g4))
...
print(nx.info(g5))
print("Number od nodes:",nx.number_of_nodes(g5))
